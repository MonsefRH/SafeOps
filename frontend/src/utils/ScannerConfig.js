...
// Color palette for vulnerability scanner
...
export const sourceTypeConfig = [
  {
    ...
    description: 'Scan vulnerabilities in your selected repositories'
  },
  {
    type: 'github',
    label: 'GitHub link',
    ...
    description: 'Scan vulnerabilities from a GitHub repository URL'
  },
  {
    type: 'code',
    label: 'Code',
    icon: <CodeBracketSquareIcon className="h-5 w-5" />,
    description: 'Paste your code directly for vulnerability analysis'
  },
  {
    type: 'file',
    label: 'File',
    icon: <CloudArrowDownIcon className="h-5 w-5" />,
    description: 'Upload files for vulnerability scanning'
  },
  {
    type: 'jenkinsfile',
    label: 'Jenkinsfile',
