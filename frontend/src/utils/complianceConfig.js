...
// Color palette for compliance checker
...
export const sourceTypeConfig = [
  {
    ...
    description: 'Analyze compliance for your selected repositories'
  },
  {
    type: 'github',
    label: 'GitHub link',
    ...
    description: 'Check compliance from a GitHub repository URL'
  },
  {
    type: 'code',
    label: 'Code',
    icon: <CodeBracketSquareIcon className="h-5 w-5" />,
    description: 'Paste your code directly for compliance analysis'
  },
  {
    type: 'file',
    label: 'File',
    icon: <CloudArrowDownIcon className="h-5 w-5" />,
    description: 'Upload files for compliance checking'
  },
  {
    type: 'jenkinsfile',
    label: 'Jenkinsfile',
